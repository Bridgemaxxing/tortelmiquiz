...
for (let i = 0; i < 3; i++) {
    for (let j = 0; j < 4; j++) {
        //console.log(i+" "+j)
       sz+=`<img id="${szamlalo}" onclick="nagyit(this.id)" src="a${szamlalo}.jpg" onmouseover="szegelyRajzol(this.id)" onmouseout="szegelyTorol(this.id)" alt="" style="width:100px;margin:5px;border:2px solid white">` 
       szamlalo++
    }
    sz+=`<br>`
}
...
function nagyit(id){
    ...
    elozo=id
    document.getElementById("nagyKep").innerHTML=`<img src="a${id}.jpg" alt="" style="width:640px" >`
